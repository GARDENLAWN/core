...
namespace GardenLawn\Core\Model\Carrier;

use GardenLawn\Shippingquote\Model\ResourceModel\Grid\Collection;
...
class CourierElevatorShipping extends AbstractCarrier implements
    CarrierInterface
{
    protected ManagerInterface $messageManager;
    protected $_code = 'courierelevatorshipping';
    protected ResultFactory $_rateResultFactory;
    protected MethodFactory $_rateMethodFactory;
    protected Collection $shippingQuoteFactory;
    ...
    public function __construct(
        ...
        Collection           $shippingQuoteFactory,
